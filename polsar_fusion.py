...
# def swt_pca(E, nc):
#     # Paso 1: Descomposición SWT de las imágenes de entrada
#     cA = []
#     cH = []
#     cV = []
#     cD = []
...
#     # Paso 2: Fusión de coeficientes por PCA
...
#     # Paso 3: Combinación de coeficientes por regla de fusión
...
#     # Paso 4: Reconstrucción de la imagen fusionada utilizando SWT inverso
...
def show_fusion_evidence(pauli, nrows, ncols, FUSION, img_rt):
    ...
    # Ajustar límites de los ejes según dimensiones de la imagen
    ax.set_xlim(0, ncols)
    ax.set_ylim(nrows, 0)

    # Guardar la imagen en formato PDF sin márgenes
